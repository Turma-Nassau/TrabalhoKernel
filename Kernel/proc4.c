...
#define PROC_NAME "LEVI_HOLLAND_PROC_FS"
...
/* Funcao funcao chamada no final da sequencia. */
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("LEVI HOLLAND");
MODULE_DESCRIPTION("Pseudo sistema de aquivos para hieraquia de processos.");
